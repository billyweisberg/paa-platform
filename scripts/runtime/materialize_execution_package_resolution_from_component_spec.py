...
SPEC_PATH = REPO_ROOT / "docs" / "2_Design" / "2026-05-17-execution-package-resolution-service-component-spec.md"
...
VALUES (
  ...
  {sql_literal('execution package context resolution from governed component spec')},
  {sql_literal(identity.system_layer)}::paa.system_layer,
  {sql_literal(identity.tier)}::paa.component_tier,
  {sql_literal('Materialized from governed ExecutionPackageResolutionService component spec tables.')},
...
def main() -> int:
    ...
    plan_repo.upsert_implementation_plan(
        ImplementationPlanUpsertSpec(
            ...
            provenance={
                "source": "scripts/runtime/materialize_execution_package_resolution_from_component_spec.py",
