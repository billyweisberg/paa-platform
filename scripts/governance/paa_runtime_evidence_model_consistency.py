...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Check runtime-evidence to model consistency for governed components.")
...
def main() -> int:
    ...
    reports = check_runtime_evidence_model_consistency(
        component_names,
