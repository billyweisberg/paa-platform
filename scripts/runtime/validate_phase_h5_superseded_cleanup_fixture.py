...
ISSUE_NUMBER = 106
ROLE_BRANCH = 'issue-106-dev-h5-fixture'
...
def main() -> int:
    ...
    decision_result = {'ok': True, 'workflow_stage': 'qa_superseded', 'decision_type': 'supersede_branch_lineage'}
    result = WORKTREE_SERVICE.superseded_cleanup(
        RuntimeWorktreeCleanupRequest(
            repo_root=CONSUMER_REPO,
            target_role='python-team',
            lineage_view=lineage_view,
