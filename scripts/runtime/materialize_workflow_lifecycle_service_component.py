...
VALUES (
  ...
  {sql_literal('coordinate workflow-state reads and transition application for supported families')},
  'domain-services'::paa.system_layer,
  'runtime'::paa.component_tier,
  {sql_literal('Service boundary for workflow lifecycle evaluation, application, and state-view coordination.')},
...
"""
    ...
    if fallback_record is None:
        raise RuntimeError("Failed to resolve anchor implementation plan record for workflow materialization proof.")
...
"""
    ...
    component_repo.upsert_component_element(
        ComponentElementUpsertSpec(
            ...
            title="Workflow Lifecycle Service Interfaces",
            definition={
                "primary_surface": "packages/paa-core/src/paa_core/services/workflow_lifecycle/contracts.py",
                "responsibility": "define the workflow lifecycle service contract",
            },
    ...
    component_repo.upsert_component_element(
        ComponentElementUpsertSpec(
            ...
            title="Workflow Lifecycle DTOs",
            definition={
                "primary_surface": "packages/paa-core/src/paa_core/services/workflow_lifecycle/models.py",
                "responsibility": "define workflow lifecycle request, state-view, and result models",
            },
            metadata={"component_name": COMPONENT_NAME},
        )
    )
    component_repo.upsert_component_element(
        ComponentElementUpsertSpec(
            ...
            title="Workflow Lifecycle Service Functions",
            definition={
                "primary_surface": "packages/paa-core/src/paa_core/services/workflow_lifecycle/default.py",
                "responsibility": "implement workflow evaluation and transition application behavior",
            },
            metadata={"component_name": COMPONENT_NAME},
        )
    )
    component_repo.upsert_component_element(
        ComponentElementUpsertSpec(
            ...
            title="Workflow Lifecycle Verification Surfaces",
            definition={
                "primary_surface": "tests/unit/test_workflow_lifecycle_service.py",
                "responsibility": "prove workflow lifecycle evaluation and transition behavior",
            },
            metadata={"component_name": COMPONENT_NAME},
        )
    )
    ...
    component_repo.upsert_component_element_realization(
        ComponentElementRealizationUpsertSpec(
            ...
            realization_key="workflow_lifecycle_service_interface",
            title="WorkflowLifecycleService Interface",
            status="planned",
            sequence_order=10,
            artifact_ref={"module_path": "packages/paa-core/src/paa_core/services/workflow_lifecycle/contracts.py"},
    ...
    component_repo.upsert_component_element_realization(
        ComponentElementRealizationUpsertSpec(
            ...
            realization_key="workflow_lifecycle_service_dto",
            title="Workflow Lifecycle DTOs",
            status="planned",
            sequence_order=20,
            artifact_ref={"module_path": "packages/paa-core/src/paa_core/services/workflow_lifecycle/models.py"},
    ...
    component_repo.upsert_component_element_realization(
        ComponentElementRealizationUpsertSpec(
            ...
            realization_key="workflow_lifecycle_service_implementation",
            title="DefaultWorkflowLifecycleService",
            status="planned",
            sequence_order=30,
            artifact_ref={"module_path": "packages/paa-core/src/paa_core/services/workflow_lifecycle/default.py"},
    ...
    component_repo.upsert_component_element_realization(
        ComponentElementRealizationUpsertSpec(
            ...
            realization_key="workflow_lifecycle_service_tests",
            title="Workflow Lifecycle Service Unit Tests",
            status="planned",
            sequence_order=40,
            artifact_ref={"module_path": "tests/unit/test_workflow_lifecycle_service.py"},
            definition={"artifact_kind": "test_module"},
            metadata={"component_name": COMPONENT_NAME},
        )
    )

    interface_realization_id = _realization_id(component_id, "workflow_lifecycle_service_interface")
    dto_realization_id = _realization_id(component_id, "workflow_lifecycle_service_dto")
    implementation_realization_id = _realization_id(component_id, "workflow_lifecycle_service_implementation")
    test_realization_id = _realization_id(component_id, "workflow_lifecycle_service_tests")
    ...
    plan_repo.upsert_implementation_plan(
        ImplementationPlanUpsertSpec(
            ...
            plan_title="WorkflowLifecycleService governed materialization proof slice",
            ...
            touch_surfaces={
                "modules": [
                    "packages/paa-core/src/paa_core/services/workflow_lifecycle/contracts.py",
                    "packages/paa-core/src/paa_core/services/workflow_lifecycle/models.py",
                    "packages/paa-core/src/paa_core/services/workflow_lifecycle/default.py",
                    "tests/unit/test_workflow_lifecycle_service.py",
                ]
            },
            ...
            verification_plan={
                "surface_refs": ["tests/unit/test_workflow_lifecycle_service.py"],
                "required_surface_count": 1,
            },
            provenance={
                "source": "scripts/runtime/materialize_workflow_lifecycle_service_component.py",
    ...
    if plan_record is None:
        raise RuntimeError("Failed to resolve materialized workflow lifecycle plan record.")
    ...
    plan_repo.upsert_implementation_plan_activity(
        ImplementationPlanActivityUpsertSpec(
            ...
            activity_title="WorkflowLifecycleService Interface",
            activity_kind="artifact_construction",
            activity_state="planned",
            sequence_order=10,
            component_element_id=interface_element_id,
            component_element_realization_id=interface_realization_id,
            target_path="packages/paa-core/src/paa_core/services/workflow_lifecycle/contracts.py",
    ...
    plan_repo.upsert_implementation_plan_activity(
        ImplementationPlanActivityUpsertSpec(
            implementation_plan_id=plan_record.implementation_plan_id,
            activity_key="define-lifecycle-dtos",
            activity_title="Workflow Lifecycle DTOs",
            activity_kind="artifact_construction",
            activity_state="planned",
            sequence_order=20,
            component_element_id=dto_element_id,
            component_element_realization_id=dto_realization_id,
            target_path="packages/paa-core/src/paa_core/services/workflow_lifecycle/models.py",
    ...
    plan_repo.upsert_implementation_plan_activity(
        ImplementationPlanActivityUpsertSpec(
            ...
            activity_title="DefaultWorkflowLifecycleService",
            activity_kind="artifact_construction",
            activity_state="planned",
            sequence_order=30,
            component_element_id=functions_element_id,
            component_element_realization_id=implementation_realization_id,
            target_path="packages/paa-core/src/paa_core/services/workflow_lifecycle/default.py",
    ...
    plan_repo.upsert_implementation_plan_activity(
        ImplementationPlanActivityUpsertSpec(
            ...
            activity_title="Workflow Lifecycle Service Unit Tests",
            activity_kind="verification",
            activity_state="planned",
            sequence_order=40,
            component_element_id=verification_element_id,
            component_element_realization_id=test_realization_id,
            target_path="tests/unit/test_workflow_lifecycle_service.py",
            target_module="test_workflow_lifecycle_service.py",
    ...
    plan_repo.upsert_implementation_plan_activity_dependency(
        ImplementationPlanActivityDependencyUpsertSpec(
            ...
            successor_activity_key="define-lifecycle-dtos",
            notes="Lifecycle DTO surface follows the contract boundary for the service.",
        )
    )
    plan_repo.upsert_implementation_plan_activity_dependency(
        ImplementationPlanActivityDependencyUpsertSpec(
            implementation_plan_id=plan_record.implementation_plan_id,
            predecessor_activity_key="define-lifecycle-dtos",
            successor_activity_key="implement-service-default",
            notes="Implementation follows the workflow lifecycle request and result models.",
        )
    )
    plan_repo.upsert_implementation_plan_activity_dependency(
        ImplementationPlanActivityDependencyUpsertSpec(
            ...
            notes="Verification follows workflow lifecycle implementation materialization.",
        )
    )
    ...
    output = {
        ...
        "realization_keys": [
            ...
            "workflow_lifecycle_service_dto",
            "workflow_lifecycle_service_implementation",
            "workflow_lifecycle_service_tests",
        ],
    }
