...
def build_synthetic_qa_packet() -> Path:
    ...
    packet['message_id'] = 'fcore-qa-2026-05-07-issue106-reset-cleanup-fixture'
    ...
    payload['recommended_action'] = {
        ...
        'next_step': 'TechLead should record a reset-required recovery decision before cleanup.'
    }
    packet['authority_context']['task_id'] = 'py-p6-retirement-boundary-diagnostics-exposure'
    out_path = CONSUMER_REPO / '.project' / 'data' / 'paa' / 'reports' / 'phase-h4-reset-cleanup.synthetic-qa.json'
...
def main() -> int:
    ...
    fake_lineage_view = {
        ...
        'lineage': {
            ...
            'reset_reason': 'Synthetic validation fixture for Phase H4 positive-path testing.',
        ...
        'recommended_actions': [
            {
                ...
                'reason': 'Synthetic Phase H4 fixture requires a reset-required recovery path.',
    ...
    try:
        args = SimpleNamespace(
            ...
            worktree_hint=ROLE_BRANCH,
            reset_reason='Synthetic validation fixture for Phase H4 positive-path testing.',
            output=CONSUMER_REPO / '.project' / 'data' / 'paa' / 'reports' / 'phase-h4-reset-cleanup.json',
            review_output=CONSUMER_REPO / '.project' / 'data' / 'paa' / 'reports' / 'phase-h4-reset-cleanup.md',
        )
        result = techlead.reset_cleanup(args)
    finally:
