...
from paa_core.services.dev_worker import DefaultDevWorkerService, DevWorkerRequest
...
class _WorkerResultPublisher:
    ...
    def publish_worker_result(
        ...
        *,
        ...
        execution_result = worker_result.execution_result or {}
...
class DevRuntimeHost:
    def __init__(
        ...
        *,
        ...
        dev_worker_service: object,
        worker_result_publisher: object | None,
        actor_name: str,
        host_name: str,
...
def build_dev_runtime_host(
    ...
    *,
    ...
    queue_client = handoff_runtime.RabbitMQManagementClient(
        user=handoff_runtime.DEFAULT_USER,
        password=handoff_runtime.DEFAULT_PASSWORD,
        host=handoff_runtime.DEFAULT_HOST,
        port=handoff_runtime.DEFAULT_MANAGEMENT_PORT,
