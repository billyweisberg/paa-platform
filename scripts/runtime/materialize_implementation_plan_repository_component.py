...
VALUES (
  ...
  {sql_literal('provide structured persistence access to implementation-plan truth')},
  'infrastructure-ports'::paa.system_layer,
  'runtime'::paa.component_tier,
  {sql_literal('Persistence boundary for implementation-plan project-design truth.')},
...
"""
    ...
    if fallback_record is None:
        raise RuntimeError("Failed to resolve anchor implementation plan record for materialization proof.")
...
"""
    ...
    component_repo.upsert_component_element(
        ComponentElementUpsertSpec(
            ...
            definition={
                "primary_surface": "packages/paa-core/src/paa_core/repositories/implementation_plan/contracts.py",
                "responsibility": "define the repository contract surface",
            },
    ...
    component_repo.upsert_component_element(
        ComponentElementUpsertSpec(
            ...
            definition={
                "primary_surface": "packages/paa-core/src/paa_core/repositories/implementation_plan/postgres.py",
                "responsibility": "implement repository persistence behavior",
            },
            metadata={"component_name": COMPONENT_NAME},
        )
    )
    component_repo.upsert_component_element(
        ComponentElementUpsertSpec(
            ...
            title="Repository Verification Surfaces",
            definition={
                "primary_surface": "tests/unit/test_implementation_plan_repository.py",
                "responsibility": "prove repository persistence behavior",
            },
            metadata={"component_name": COMPONENT_NAME},
        )
    )
    ...
    component_repo.upsert_component_element_realization(
        ComponentElementRealizationUpsertSpec(
            ...
            realization_type_key="repository_interface",
            realization_key="implementation_plan_repository_interface",
            title="ImplementationPlanRepository Interface",
            status="planned",
            sequence_order=10,
            artifact_ref={"module_path": "packages/paa-core/src/paa_core/repositories/implementation_plan/contracts.py"},
            definition={"artifact_kind": "repository_interface"},
            metadata={"component_name": COMPONENT_NAME},
        )
    )
    component_repo.upsert_component_element_realization(
        ComponentElementRealizationUpsertSpec(
            ...
            realization_key="implementation_plan_repository_postgres",
            title="PostgresImplementationPlanRepository",
            status="planned",
            sequence_order=20,
            artifact_ref={"module_path": "packages/paa-core/src/paa_core/repositories/implementation_plan/postgres.py"},
            definition={"artifact_kind": "concrete_repository_class"},
            metadata={"component_name": COMPONENT_NAME},
        )
    )
    component_repo.upsert_component_element_realization(
        ComponentElementRealizationUpsertSpec(
            ...
            realization_key="implementation_plan_repository_tests",
            title="ImplementationPlanRepository Unit Tests",
            status="planned",
            sequence_order=30,
            artifact_ref={"module_path": "tests/unit/test_implementation_plan_repository.py"},
            definition={"artifact_kind": "test_module"},
            metadata={"component_name": COMPONENT_NAME},
        )
    )

    interface_realization_id = _realization_id(component_id, "implementation_plan_repository_interface")
    postgres_realization_id = _realization_id(component_id, "implementation_plan_repository_postgres")
    test_realization_id = _realization_id(component_id, "implementation_plan_repository_tests")
    ...
    plan_repo.upsert_implementation_plan(
        ImplementationPlanUpsertSpec(
            ...
            plan_title="ImplementationPlanRepository governed materialization proof slice",
            ...
            build_sequence={
                "activity_keys": [
                    ...
                    "prove-repository-behavior",
                ]
            },
            touch_surfaces={
                "modules": [
                    "packages/paa-core/src/paa_core/repositories/implementation_plan/contracts.py",
                    "packages/paa-core/src/paa_core/repositories/implementation_plan/postgres.py",
                    "tests/unit/test_implementation_plan_repository.py",
                ]
            },
            protected_constraints={"forbid": ["workflow ownership", "coder-brief assembly"]},
            verification_plan={
                "surface_refs": ["tests/unit/test_implementation_plan_repository.py"],
                "required_surface_count": 1,
            },
            provenance={
                "source": "scripts/runtime/materialize_implementation_plan_repository_component.py",
    ...
    if plan_record is None:
        raise RuntimeError("Failed to resolve materialized implementation plan record.")

    plan_repo.upsert_implementation_plan_activity(
        ImplementationPlanActivityUpsertSpec(
            implementation_plan_id=plan_record.implementation_plan_id,
            activity_key="define-repository-interface",
            activity_title="ImplementationPlanRepository Interface",
            activity_kind="artifact_construction",
            activity_state="planned",
            sequence_order=10,
            component_element_id=interface_element_id,
            component_element_realization_id=interface_realization_id,
            target_path="packages/paa-core/src/paa_core/repositories/implementation_plan/contracts.py",
            target_module="contracts.py",
            planned_artifact_type_key="repository_interface",
            metadata={"component_name": COMPONENT_NAME},
        )
    )
    plan_repo.upsert_implementation_plan_activity(
        ImplementationPlanActivityUpsertSpec(
            implementation_plan_id=plan_record.implementation_plan_id,
            activity_key="implement-postgres-repository",
            activity_title="PostgresImplementationPlanRepository",
            activity_kind="artifact_construction",
            activity_state="planned",
            sequence_order=20,
            component_element_id=functions_element_id,
            component_element_realization_id=postgres_realization_id,
    ...
    plan_repo.upsert_implementation_plan_activity(
        ImplementationPlanActivityUpsertSpec(
            implementation_plan_id=plan_record.implementation_plan_id,
            activity_key="prove-repository-behavior",
            activity_title="ImplementationPlanRepository Unit Tests",
            activity_kind="verification",
            activity_state="planned",
            sequence_order=30,
            component_element_id=verification_element_id,
            component_element_realization_id=test_realization_id,
            target_path="tests/unit/test_implementation_plan_repository.py",
            target_module="test_implementation_plan_repository.py",
    ...
    plan_repo.upsert_implementation_plan_activity_dependency(
        ImplementationPlanActivityDependencyUpsertSpec(
            implementation_plan_id=plan_record.implementation_plan_id,
            predecessor_activity_key="define-repository-interface",
            successor_activity_key="implement-postgres-repository",
            notes="Repository implementation should follow the repository interface boundary.",
        )
    )
    plan_repo.upsert_implementation_plan_activity_dependency(
        ImplementationPlanActivityDependencyUpsertSpec(
            implementation_plan_id=plan_record.implementation_plan_id,
            predecessor_activity_key="implement-postgres-repository",
            successor_activity_key="prove-repository-behavior",
            notes="Verification follows repository implementation materialization.",
        )
    )
    ...
    output = {
        ...
        "component_element_keys": ["functions", "interfaces", "verification_surfaces"],
        "realization_keys": [
            "implementation_plan_repository_interface",
            "implementation_plan_repository_postgres",
            "implementation_plan_repository_tests",
        ],
    }
